...
{
    Q_OBJECT
    Q_PROPERTY(double borderMargins READ borderMargins NOTIFY borderMarginsChanged)
public:
...
public:
    double borderMargins() const
    {
        return m_frames.left();
    }

public slots:
    void showFullScreen();
signals:
    void borderMarginsChanged(double borderMargins);
